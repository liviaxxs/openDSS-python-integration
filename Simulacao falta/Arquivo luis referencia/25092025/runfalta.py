...
dss_file = pathlib.Path(script_path).joinpath("Ieee4node.DSS")
...
dss.text("New fault.Falta_A bus1=4.1 phases=1 r=5")
print("Falta monofásica adicionada no barramento 4.1 com R=5Ω")

# 4. Cria monitor em uma linha (outra escolha possível: no transformador)
dss.text("New Monitor.Mon_Falta element=Line.LINHA_S-1 terminal=1 mode=0")
